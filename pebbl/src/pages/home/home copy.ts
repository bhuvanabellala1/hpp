...
export class HomePage {
  ...
  createChart() {
    ...
    var circle = svg.selectAll("circle")
        ...
        .attr("cx", function(d, i) { if (i!=39) {return d.x} else {return 25;}})
        .attr("cy", function(d, i) { if (i!=39) {return d.y} else {return 25;}})
        ...
        // function(d) { if (d.name == "Iron Throne"){ return -90} else {return -60;}}
    ...
    d3.select("circle").transition().style("fill", "gold").attr('r', 80).duration(2000).transition().duration(1000).style("fill",color(0)).attr('r',20);
